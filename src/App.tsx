...
export default function App() {
  ...
  const { isLoading, setIsLoading, setUser, setAccessToken, setCurrentScreen } = state
  ...
  return (
    <>
      ...
      {state.currentScreen === 'create-post' && (
        <CreatePost {...appProps} />
      )}
      
      {state.currentScreen === 'gallery' && (
        <ImageGallery {...appProps} />
      )}
      
      {state.currentScreen === 'settings' && (
        <SettingsScreen {...appProps} />
      )}
    </>
  )
}